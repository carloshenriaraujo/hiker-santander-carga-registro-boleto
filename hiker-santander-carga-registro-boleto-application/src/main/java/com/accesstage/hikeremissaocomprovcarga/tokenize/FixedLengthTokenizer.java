package com.accesstage.hikeremissaocomprovcarga.tokenize;
...
public class FixedLengthTokenizer extends AbstractLineTokenizer {
	...
	private static final String FORMATA_240_POSICOES = "%-240s";
	...
	private String getTratamentoLinhaTamanhoFixo(String line) {
		return String.format(FORMATA_240_POSICOES, line);
	}
